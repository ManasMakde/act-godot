# 🎭 Act Godot Documentation v0.4.0-alpha
...
| [BlockType](#blocktype) | `INTERRUPT`, `PERSISTENT` |
...
| public | Dictionary[Act, bool] | [get_blocked_by_acts](#get_blocked_by_acts)() |
| public | Dictionary[Act, BlockType] | [get_acts_to_block](#get_acts_to_block)() |
| public | [Status](#status) | [get_status](#get_status)() |
| public | [Outcome](#outcome) | [get_outcome](#get_outcome)() |
| public | int | [get_perform_count](#get_perform_count)() |
| public | int | [get_tick_count](#get_tick_count)() |
| public | int | [get_physics_tick_count](#get_physics_tick_count)() |
...
| Signature    | Signals |
|--------------|-------|
| \(theater: Theater, new_enabled: bool\) | [on_enable_changed](#on_enable_changed_theater) |
...
### <a id="on_prologue_complete"></a> signal on_prologue_complete(act: Act, p_act: Act, p_outcome: Outcome)
Emitted whenever a single prologue act has completed.
...
func _ready():
	...
	damaged_act.init("Damaged Act", theater)
```
...
### <a id="get_perform_count"></a> func get_perform_count() -> int
...
### <a id="get_tick_count"></a> func get_tick_count() -> int
Returns how many times [`_tick()`](#_tick) has been called since [initialized](#init).


---


### <a id="get_physics_tick_count"></a> func get_physics_tick_count() -> int
Returns how many times [`_physics_tick()`](#_physics_tick) has been called since [initialized](#init).
...
### <a id="on_enable_changed_theater"></a> signal on_enable_changed(theater: Theater, new_enabled: bool)
